...
$query = "select * from barang_keluar join tb_pelanggan on barang_keluar.kode_pelanggan = tb_pelanggan.kode_pelanggan where kode_transaksi ='" . $kode_trKeluar . "'";
...
<center>
	<div class="container-fluid">
		<table>
			<tr>
				<td>
					<h4>Nota Penjualan: <?= $_GET['kode_transaksi'] ?></h4>
				</td>
				<td>
					<h4><b> ------ </b></h4>
				</td>
