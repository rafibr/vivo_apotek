			...
			<div class="table-responsive">
				<table class="table table-bordered table-hover" id="dataTable" cellspacing="0">
					...
					<tbody>
						...
						$no = 1;
						$query = "select *, sum(jumlah) as total_item from barang_keluar group by kode_transaksi";
						...
						?>
							<tr>
								<td><?= $no++; ?>.</td>
								<td>
									<a href="?page=barangkeluar&aksi=ubahbarangkeluar&kode_transaksi=<?= $data['kode_transaksi']; ?>">
										<?= $data['kode_transaksi']; ?>
									</a>
								</td>
								...
								<td>
									...
									<div class="btn-group sm" role="group" aria-label="Basic example">
										<a href="?page=barangkeluar&aksi=ubahbarangkeluar&kode_transaksi=<?= $data['kode_transaksi']; ?>" class="btn btn-warning btn-sm">Detail</a>
										<!-- <a href="?page=barangkeluar&aksi=hapusbarangkeluar&kode_transaksi=<?= $data['kode_transaksi']; ?>" class="btn btn-danger btn-sm">Hapus</a> -->
									</div>
								</td>
							</tr>
						<?php
